...
def priority_non_preemptive(processes):
    ...
    print_results("Priority (Non-preemptive)", completed)
    ...
    while processes or ready:
        ...
        if ready:
            ...
            if p.remaining_time == 0:
                ...
                heapq.heappush(ready, (p.priority, p.arrival_time, p))
        else:
            time += 1

    print_results("Priority (Preemptive)", completed)
...
if __name__ == "__main__":
    ...
    priority_non_preemptive(copy.deepcopy(sample_processes))
    priority_preemptive(copy.deepcopy(sample_processes))
